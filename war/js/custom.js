				...
				$(".portfolio-grid ul li")
						.click(
								function() {
									...
									var count_before = $(this).closest("li")
											.prevAll("li").length;

									var this_opacity = $(this).find(
											".item-info-overlay")
											.css("opacity");
									var this_display = $(this).find(
											".item-info-overlay")
											.css("display");

									if ((this_opacity == 0)
											|| (this_display == "none")) {
										$(this).find(".item-info-overlay")
												.fadeTo(250, 0.9);
									} else {
										$(this).find(".item-info-overlay")
												.fadeTo(250, 0);
...
$(window).load(function() {
	...
	$("a[rel^='prettyPhoto']").prettyPhoto({
		...
		overlay_gallery : false, /*
									 * If set to true, a gallery will overlay
									 * the fullscreen image on mouse over
									 */
